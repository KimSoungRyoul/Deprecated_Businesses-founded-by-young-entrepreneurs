...
<link rel="shortcut icon" href="/resources/img/improveicon.ico">
 <head>
	...
	<!--[if lt IE 9]>
	<script src="/resources/pc/js/html5shiv.js"></script>
...
<div id="wrap">
	<!--상단-->
	<header class="scroll">
		<!-- <div w3-include-html="/inc/header.inc"></div>  -->
	</header>
	<!--//상단-->
	<!--메인 컨텐츠-->
	<div id="fullpage">
			...
			<div class="mvWrap">
				...
				<ul class="visual">
					<li>
						...
						<a href="#;"><img src="/resources/pc/img/main/btn_google.png" alt="플레이스토어 바로가기"/></a>
				...
				<article>
					<div class="dtBox">
						<div>
							<article>
								<div class="icon">
									<div><img src="/resources/pc/img/main/icon_bt1.png"/></div>
								</div>
								<dl>
									<dt>인적사항</dt>
							...
							<article>
								<div class="icon">
									<div><img src="/resources/pc/img/main/icon_bt2.png"/></div>
								</div>
								<dl>
									<dt>학력사항 ~ 어학능력</dt>
							...
							<article>
								<div class="icon">
									<div><img src="/resources/pc/img/main/icon_bt3.png"/></div>
								</div>
								<dl>
									<dt>PDF 변환하기</dt>
						...
						<img src="/resources/pc/img/main/img_dtList1.png"/>
					</div>
				</article>
			</div>
		</div>
		<div class="section psn" id="section3">
			<div class="wrap">
				<div class="psnImg">
					<article>
						<ul class="psnList">
							<li><img src="/resources/pc/img/main/img_psn1.png"/></li>
							<li><img src="/resources/pc/img/main/img_psn2.png"/></li>
							<li><img src="/resources/pc/img/main/img_psn3.png"/></li>
							<li><img src="/resources/pc/img/main/img_psn4.png"/></li>
						</ul>
					</article>
				</div>
				<div class="psnTxt">
			...
			<footer class="main">
				<div w3-include-html="/resources/pc/inc/footer.inc.html"></div> 
			</footer>
		</div>
	</div>
	<!--//메인 컨텐츠-->
