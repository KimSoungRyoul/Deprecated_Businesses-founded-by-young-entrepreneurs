...
function getAddr(){
	// AJAX 주소 검색 요청
	$.ajax({
		url:"/RoadName_Address/getAddrApi.do"									// 고객사 API 호출할 Controller URL
		,type:"post"
...
function makeList(xmlStr){
	...
	htmlStr +="<tr>우편번호</tr> <tr>           도로명 주소</tr>"
...
<form name="form" id="form" method="post">
  ...
  <input type="hidden" name="confmKey" value="U01TX0FVVEgyMDE2MDkxMjIyNDUyOTE1MjE0"/>		<!-- 요청 변수 설정 (승인키) -->
